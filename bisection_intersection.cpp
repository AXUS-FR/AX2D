...
bisection_intersection::bisection_intersection(qreal _distance, QPointF _cross_point, Vertice *_vertice1, Vertice *_vertice2)
{
...
QPointF bisection_intersection::get_cross_point() const
{
    return cross_point;
}
